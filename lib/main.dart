...
import 'package:dialogflow_flutter_plus/message.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Flutter Demo',
      theme: ThemeData(
        scaffoldBackgroundColor: Color(0xFFEDFFF4),
      ...
      if (messages?.isNotEmpty ?? false) {
        ...
        if (message != null && message is Map) {
          ...
          if (textList != null && textList is List) {
            var responseText = textList.isNotEmpty ? textList[0].toString() : 'No response';
            setState(() {
              messsages.insert(0, {"data": 0, "message": responseText});
              firstMessageSent = true;

              if (!chooseOptionDisplayed) {
                messsages.insert(0, {"data": 0, "message": "Choose an option:"});
  ...
  Widget _buildQuickReplyButton(String option, String query) {
    return OutlinedButton(
      ...
      style: OutlinedButton.styleFrom(
        side: BorderSide(color: const Color.fromARGB(255, 11, 196, 140), width: 2),
      ...
      child: Text(
        option,
        style: TextStyle(color: const Color.fromARGB(255, 11, 196, 140)),
      ),
    );
  }
...
Widget build(BuildContext context) {
  return Scaffold(
    appBar: AppBar(
      backgroundColor: Color.fromARGB(255, 75, 247, 132),
      title: Center(
        ...
        Flexible(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) =>
                chat(messsages[index]["message"].toString(), messsages[index]["data"]),
          ),
        ),
  ...
  Padding(
    ...
    child: Row(
      children: [
        ...
        IconButton(
          icon: Icon(
            showQuickReplies ? Icons.visibility : Icons.visibility_off,
            color: Colors.greenAccent,
          ),
          onPressed: () {
            setState(() {
              showQuickReplies = !showQuickReplies; // Toggle visibility
            });
          },
        ),
        ...
        if (showQuickReplies)
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _buildQuickReplyButton("Where can i find my vaccine information?", "Where can i find my vaccine information?"),
                  SizedBox(width: 10),
        ...
        children: [
          ...
          Padding(
            ...
            child: Bubble(
              ...
              color: data == 0 ? const Color.fromARGB(255, 11, 196, 140) : const Color.fromARGB(255, 11, 196, 140),
              child: Padding(
