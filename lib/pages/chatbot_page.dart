  ...
  void response(String query) async {
    try {
      AuthGoogle authGoogle =
          await AuthGoogle(
            fileJson: "assets/jsons/healtcare_service.json",
          ).build();
  ...
  Widget _buildQuickReplyButton(String option, String query) {
    return OutlinedButton(
      ...
      style: OutlinedButton.styleFrom(
        side: BorderSide(
          color: const Color.fromARGB(255, 11, 196, 140),
          width: 2,
        ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text("Healthcare Chatbot")),
      ),
      body: Column(
        children: <Widget>[
          Padding(
        ...
        children: [
          ...
          Padding(
            ...
            child: Bubble(
              ...
              color:
                  data == 0
                      ? const Color.fromARGB(255, 11, 196, 140)
                      : const Color.fromARGB(255, 11, 196, 140),
              child: Padding(
